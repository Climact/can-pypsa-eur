...
author_pdf = "Tom Brown (KIT, TUB, FIAS), Jonas Hoersch (KIT, FIAS), \\\\ Fabian Hofmann (TUB, FIAS), Fabian Neumann (TUB, KIT), \\\\ Marta Victoria (Aarhus University), Lisa Zeyen (KIT, TUB), \\\\ Vincent Laguna (Climact), Thomas Gilon (Climact), \\\\ Dimitri Krings (Climact), Benoît Martin (Climact)"
